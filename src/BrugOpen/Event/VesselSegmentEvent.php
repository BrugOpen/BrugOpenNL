...
class VesselSegmentEvent
{
     ...
     */
    public function getVesselSegment()
    {
        return $this->vesselSegment;
    }

    /**
     * @param \BrugOpen\Model\VesselSegment
     */
    public function setVesselSegment($vesselSegment)
    {
        $this->vesselSegment = $vesselSegment;
    }
