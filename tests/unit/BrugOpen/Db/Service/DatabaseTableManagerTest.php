...
class DatabaseTableManagerTest extends TestCase
{
    ...
    public function testCreateSelectStatementParametersWithComparisonCriterium()
    {
        $tableManager = new DatabaseTableManager(null);

        // comparison 'equal'
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('field1', Criterium::OPERATOR_IS, 'bar1');
        ...
        $this->assertEquals('SELECT * FROM foo_table WHERE (field1 = :c0)', $parameters[0]);
        $this->assertNotEmpty($parameters[1]);
        $this->assertCount(1, $parameters[1]);
        $this->assertArrayHasKey('c0', $parameters[1]);
        $this->assertEquals('bar1', $parameters[1]['c0']);
        ...
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('field1', Criterium::OPERATOR_IS_NOT, 2);
        ...
        $this->assertCount(1, $parameters[1]);
        $this->assertArrayHasKey('c0', $parameters[1]);
        $this->assertEquals(2, $parameters[1]['c0']);

        // comparison 'less than'
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('field1', Criterium::OPERATOR_LT, 4);
        ...
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('field1', Criterium::OPERATOR_LE, 4);
        ...
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('field1', Criterium::OPERATOR_GT, 4);
        ...
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('field1', Criterium::OPERATOR_GE, 4);
    ...
    public function testCreateSelectStatementParametersWithComparisonCriteriumDateTime()
    {
        ...
        // comparison 'equal'
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('created', Criterium::OPERATOR_IS, new \DateTime('2023-01-20 12:00:00 GMT+02:00'));
        ...
        $this->assertEquals('SELECT * FROM foo_table WHERE (created = FROM_UNIXTIME(:c0))', $parameters[0]);
        $this->assertNotEmpty($parameters[1]);
        $this->assertCount(1, $parameters[1]);
        $this->assertArrayHasKey('c0', $parameters[1]);
        ...
        // comparison 'not equal'
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('created', Criterium::OPERATOR_IS_NOT, new \DateTime('2023-01-20 12:00:00 GMT+02:00'));
        ...
        // comparison 'less than'
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('created', Criterium::OPERATOR_LT, new \DateTime('2023-01-20 12:00:00 GMT+02:00'));
        ...
        // comparison 'less than or equal'
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('created', Criterium::OPERATOR_LE, new \DateTime('2023-01-20 12:00:00 GMT+02:00'));
        ...
        // comparison 'greater than'
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('created', Criterium::OPERATOR_GT, new \DateTime('2023-01-20 12:00:00 GMT+02:00'));
        ...
        // comparison 'greater than or equals'
        $criteria = array();
        $criteria[] = new CriteriumFieldComparison('created', Criterium::OPERATOR_GE, new \DateTime('2023-01-20 12:00:00 GMT+02:00'));
    ...
    public function testCreateUpdateStatementParametersNoCriteriaIntValue()
    {
        ...
        $this->assertTrue(is_array($parameters[1]['v1']));
        ...
        $this->assertTrue(is_array($parameters[1]['v2']));
    ...
    public function testCreateUpdateStatementParametersWithCriteria()
    {
        ...
        $this->assertTrue(is_array($parameters[1]['c0']));
